...
interface IValidationRegistry {
    function requestValidation(bytes32 jobId, string calldata deliverableCID, string calldata rubric) external;
    function submitAttestation(bytes32 jobId, bytes32 validatorId, uint256 verdict, uint256 confidence) external;
}
