        ...
        returns (BalanceDelta memory delta)
    {
        ...
        if (hook != address(0)) {
            (bool ok, bytes memory ret) =
                hook.call(abi.encodeWithSelector(IHooks.beforeSwap.selector, msg.sender, key, params, hookData));
        ...
        if (hook != address(0)) {
            (bool ok2,) =
                hook.call(abi.encodeWithSelector(IHooks.afterSwap.selector, msg.sender, key, params, delta, hookData));
